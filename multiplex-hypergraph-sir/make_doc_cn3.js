...
k.push(caption([
  ...
  R(" 平面上的分布，白线为 ", { size: SMALL }), ...E("C=1", SMALL),
  R(" 等值线，即单个群体已足以自我复制的界。(d) 递推 (2.5) 的状态格点 ", { size: SMALL }),
  ...E("u(i,s)", SMALL), R("（", { size: SMALL }), ...E("m=8", SMALL), R("、", { size: SMALL }), ...E("λ=1", SMALL),
  R("），级联规模由角点 ", { size: SMALL }), ...E("u(1,m−1)", SMALL),
