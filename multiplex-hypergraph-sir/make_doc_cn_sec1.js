...
k.push(lead("阈值自洽。", [R("阈值公式 (1.10) 与方程组自身在无病定态的线性失稳独立比对：将 (1.8) 作数值 Jacobian、对最大实部特征值二分求阈值，与 "), ...E("ρ(N)=1"), R(" 在六组构型（含反相关度分布、非对称速率与群体规模、三层、以及成对退化情形 "), ...E("λ_{c}=1/3"), R("）上的相对差均不超过 "), ...E("1×10^{−8}"), R("，即数值 Jacobian 的有限差分精度。两条路径不共享代码；若以 "), ...E("(m−1)T"), R(" 取代群内级联 C，该一致性立即消失。")]));
