...
k.push(P([R("与 (1.7) 自洽。节点侧由 (1.5) 与 "), ...E("Ṙ=μI"), R("、"), ...E("I=1−S−R"), R(" 闭合。初始条件 "), ...E("x^{(a)}_{s,i,0}(0)=C(m_{a}−1,i)(1−ε)^{s}ε^{i}"), R("，其余为零，"), ...E("Φ_{a}(0)=1"), R("。方程组共 "), ...E("Σ_{a}C(m_{a}+1,2)+1"), R(" 维（各层的群体计数加上节点侧的单个独立标量 R，其中 S 由 (1.5) 决定、"), ...E("I=1−S−R"), R(" 导出），与系统规模 N 无关；"), ...E("M=2"), R("、"), ...E("m=(3,4)"), R(" 时为 "), ...E("16+1=17"), R(" 个方程，积分一次即给出完整的 "), ...E("S(t)、I(t)、R(t)"), R(" 与终态规模。")], { ind: false }));
