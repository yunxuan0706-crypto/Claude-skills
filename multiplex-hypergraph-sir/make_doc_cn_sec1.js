...
k.push(lead("含时复现。", [R("如图 2(a) 所示，群体闭合和精确仿真在整个时间演化上逐点吻合，"), ...E("S(t)"), R(" 和 "), ...E("I(t)"), R(" 的最大偏差都小于线宽（0.0019 和 0.0006），感染峰高相差约 0.3%、峰位都在 "), ...E("t≈4.4"), R("。仿真为 "), ...E("N=6000"), R("、400 次独立实现（脚本 figure2_evolution.py，含 Fenwick 树加速的精确 Gillespie）。残余偏差随系统规模增大而单调趋零，是可由增大系统消除的有限尺寸效应，而非闭合层级的系统偏差。")]));
