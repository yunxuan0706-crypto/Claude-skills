...
k.push(P([...E("Ψ"), R(" 描述节点侧，"), ...E("ψ_{a}"), R(" 描述沿层 a 的一个成员槽到达某节点时该节点的余度分布，指数中的 "), ...E("−δ_{ac}"), R(" 即余度相减：来路那个群体不再计入。联合层度分布 "), ...E("P(k)"), R(" 是本模型的结构输入，层间的一切效应最终只经由 "), ...E("Ψ"), R(" 和 "), ...E("ψ_{a}"), R(" 的交叉项进入动力学。")], { ind: false }));
...
k.push(P([R("以 "), ...E("μ"), R(" 归一时间，"), ...E("λ_{a}=β_{a}/μ"), R("，主线取 "), ...E("θ_{a}=1"), R("。初始时刻每个节点独立地以概率 "), ...E("ε"), R(" 处于感染态、其余易感，"), ...E("ε"), R(" 即均匀初始感染比例。和有向超图不同，无向群体中每个成员既是传染源也是传染靶：一个成员被感染后群体激活，可感染同群其他成员，后者被感染又延长群体的激活时长，形成群内级联。本模型的新内容都源于此。")], { ind: false }));
...
k.push(P([R("闭合方程组不仅给出阈值，也复现整个传播过程。图 2 给出 "), ...E("M=2"), R("、"), ...E("m=(3,4)"), R("、"), ...E("N=6000"), R("、"), ...E("λ=1.6λ_{c}"), R(" 下的完整时间演化，联合层度分布 "), ...E("P(k)"), R(" 在 "), ...E("(2,2)"), R(" 和 "), ...E("(3,3)"), R(" 上各占一半，"), ...E("λ_{c}=0.0993"), R("，"), ...E("ε=0.02"), R("。群体闭合 (1.8) 和精确仿真在 "), ...E("S(t)"), R("、"), ...E("I(t)"), R(" 上的最大偏差分别为 0.0019 和 0.0006，都小于图中线宽；感染峰高相差约 0.3%，峰位 "), ...E("t≈4.4"), R("。")], { ind: false }));
// figure 2: time evolution
{
  ...
  k.push(new Paragraph({ alignment: AlignmentType.BOTH, spacing: { after: 180, line: 264 }, indent: { firstLine: 0 },
    children: [
      ...
      R("。实线为 400 次独立 Gillespie 实现的均值，灰带为 95% 置信区间，最宽处约与线宽相当；虚线为群体闭合 (1.8)。(a) 易感比例 ", { size: SMALL }),
...
k.push(lead("含时复现。", [R("如图 2 所示，群体闭合和精确仿真在整个时间演化上逐点吻合，"), ...E("S(t)"), R(" 和 "), ...E("I(t)"), R(" 的最大偏差都小于线宽（0.0019 和 0.0006），感染峰高相差约 0.3%、峰位都在 "), ...E("t≈4.4"), R("。仿真为 "), ...E("N=6000"), R("、400 次独立实现（脚本 figure2_evolution.py，含 Fenwick 树加速的精确 Gillespie）。残余偏差随系统规模增大而单调趋零，是可由增大系统消除的有限尺寸效应，而非闭合层级的系统偏差。")]));
