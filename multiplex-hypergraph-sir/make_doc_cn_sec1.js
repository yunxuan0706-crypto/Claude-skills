...
k.push(P([R("闭合方程组不仅给出阈值，也复现整个传播过程。图 2 给出 "), ...E("M=2"), R("、"), ...E("m=(3,4)"), R("、"), ...E("N=6000"), R("、"), ...E("λ=1.6λ_{c}"), R(" 下的完整时间演化，联合层度分布 "), ...E("P(k)"), R(" 在 "), ...E("(2,2)"), R(" 与 "), ...E("(3,3)"), R(" 上各占一半，"), ...E("λ_{c}=0.0993"), R("，"), ...E("ε=0.02"), R("。群体闭合 (1.8) 与精确仿真在 "), ...E("S(t)"), R(" 与 "), ...E("I(t)"), R(" 上的最大偏差分别为 0.0019 与 0.0006，均小于图中线宽；感染峰高相差约 0.3%，峰位 "), ...E("t≈4.4"), R("。群体闭合复现了完整的含时演化。")], { ind: false }));
// figure 2: time evolution
{
  ...
  k.push(new Paragraph({ alignment: AlignmentType.BOTH, spacing: { after: 180, line: 264 }, indent: { firstLine: 0 },
    children: [
      ...
      R("。黑线为 400 次独立 Gillespie 实现的均值，灰带为 95% 置信区间，最宽处约与线宽相当；蓝虚线为群体闭合 (1.8)。(a) 易感比例 ", { size: SMALL }),
