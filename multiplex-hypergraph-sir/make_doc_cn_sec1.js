...
k.push(P([R("节点状态 "), ...E("x_{v}∈{S,I,R}"), R(" 是跨层共享的——一个个体只要在任一条渠道里被感染，它在所有渠道里也都是感染态。记层 a 的群体 e 里已经感染的成员数为 "), ...E("n_{e}(t)=|e∩I(t)|"), R("。当 "), ...E("n_{e}≥θ_{a}"), R(" 时群体激活，向 e 里每个易感成员各以速率 "), ...E("β_{a}"), R(" 独立传递，否则就静默着；感染者以速率 "), ...E("μ"), R(" 康复。易感节点 u 的总风险率是")], { ind: false }));
...
k.push(P([R("闭合方程组不光给出阈值，也能把整个传播过程复现出来。图 2 画的是 "), ...E("M=2"), R("、"), ...E("m=(3,4)"), R("、"), ...E("N=6000"), R("、"), ...E("λ=1.6λ_{c}"), R(" 下的完整时间演化，联合层度分布 "), ...E("P(k)"), R(" 在 "), ...E("(2,2)"), R(" 和 "), ...E("(3,3)"), R(" 上各占一半，"), ...E("λ_{c}=0.0993"), R("，"), ...E("ε=0.02"), R("。群体闭合 (1.8) 和精确仿真在 "), ...E("S(t)"), R("、"), ...E("I(t)"), R(" 上的最大偏差分别是 0.0019 和 0.0006，都比图里的线宽还小；感染峰高只差大约 0.3%，峰位同在 "), ...E("t≈4.4"), R("。")], { ind: false }));
