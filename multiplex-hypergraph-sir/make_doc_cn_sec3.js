...
k.push(P([R("楔形的宽窄由层间耦合决定。取 §2.4 的 "), ...E("{2,4}"), R(" 族：边缘分布固定意味着两条单层线被钉死，"), ...E("ρ_{12}"), R(" 只能移动临界曲线本身。曲线随 "), ...E("ρ_{12}"), R(" 由 −1 增到 +1 而整体内移（图 3c），对称阈值由 0.106203 降到 0.092956，与 §2.4 的两个端点逐位相同；图 3(d) 把移动量画成"), ...E("Δλ_{2,c}(λ_{1},ρ_{12})"), R(" 的完整曲面。"), R("协同是多重结构的默认态", { bold: true }), R("——这一结论与多层网络传播的一般理论 [5,6] 一致，但本文将其从成对边推广至高阶超边：只要两层非完全孤立，合并阈值严格低于任一单层，§2.1 由 Perron–Frobenius 不等式 "), ...E("ρ(N)≥max_{a}N_{aa}"), R(" 给出严格下界。图 3(b) 将 "), ...E("λ_{c}(ρ_{12})"), R(" 的精确解析曲线与位形模型上的 Gillespie 精确仿真 [16] 自助分布 (bootstrap distribution) 对照，六点一致至 1.9σ。")]));
