...
k.push(lead("变号区恒为超临界。", [R("变号区与阈值之间存在一条结构性的分隔：在所有测试的分布与 m 上，变号窗口的下沿都不低于 "), ...E("2.5"), R(" 倍 "), ...E("λ_{c}"), R("（"), ...E("m=6"), R(" 至 16、四组分布上实测为 2.53 至 7.07 倍，随构型而异），图 3b 中 "), ...E("λ_{c}"), R(" 虚线因而始终位于变号区之外。这解释了上一段两个陈述何以并存："), R("再生数的偏差会变号，阈值的偏差不会", { bold: true }), R("——阈值处 λ 太小，级联因子尚未长大。二者是两个不同的命题，不可互推。")]));
...
k.push(new Paragraph({ alignment: AlignmentType.BOTH, spacing: { after: 180, line: 264 }, indent: { firstLine: 0 },
  children: [
    ...
    R("，而均场被排除 3.3σ 至 32.5σ。", { size: SMALL }),
  ] }));
...
k.push(lead("精确侧的真值。", [R("图 3 本身是两个闭合之间的比较，故其结论须有闭合以外的真值支撑。为此在位形模型多重超图上作精确的连续时间 Gillespie 仿真（含真实回路与有限 N，不用任何闭合）。取 "), ...E("N=4×10^{4}"), R("、3 张独立实现各 3000 次播种，在 "), ...E("λ=0.6λ_{c}"), R(" 与 "), ...E("0.8λ_{c}"), R("、"), ...E("m=3,5,8,12"), R(" 共八个点上，仿真的平均簇规模与精确理论一致至 "), ...E("1.3σ"), R("，而均场的预言被排除 3.3σ 至 32.5σ（图 3d）。这同时检验了 T、余度相减与级联三项。（"), ...E("N=1.2×10^{4}"), R(" 时其中一点偏离 3.1σ，增大 N 后降至 0.4σ，确认为有限尺寸效应。）")]));
